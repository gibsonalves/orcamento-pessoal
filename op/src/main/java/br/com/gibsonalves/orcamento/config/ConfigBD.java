...
@EnableJpaRepositories(basePackages = "br.com.gibsonalves.orcamento.repositorios")
public class ConfigBD {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws Exception {
		...
		entityManagerFactoryBean.setPackagesToScan("br.com.gibsonalves.orcamento.entidades");
